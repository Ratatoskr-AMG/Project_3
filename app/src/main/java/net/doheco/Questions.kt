...
/* Вопросы
    Вопрос про ViewModel  в Actviity (для splash)
    Планшет (ограничение или адаптация)
    Критично ли отсутствие SSL на серваке
...
/* Задания
    ...
    Метод отправки, серверная часть
    Текст к форме обратной связи
    Реакции формы обратной сыязи
    Статистика игрока
